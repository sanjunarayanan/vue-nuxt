                ...
                <div class="nav-global-location">
                  <nuxt-link to="/address" class="nav-a nav-a-2">
                    ...
                    <div id="glow-ingress-block">
                      ...
                      <span class="nav-line-2" id="glow-ingress-line2">Perul Parathode</span>
                    </div>
                  </nuxt-link>
                </div>
              </div>
              ...
              <div class="col-xl-6 col-lg-5 col-md-4 col-sm-6 p-0">
                <div class="nav-fill">
                  ...
                  <div class="nav-xshop-container">
                    <div class="nav-xshop">
                      <a href="" class="nav-a ">Todays Deal</a>
                      <a href="" class="nav-a ">Your amazon.com</a>
                      <a href="" class="nav-a ">Gift Card</a>
                      <a href="" class="nav-a ">Registery</a>
              ...
              <div class="col-xl-4 col-lg-5 col-md-6 col-sm-4 p-0">
                <div class="nav-tools">
                   ...
                   <span class="icp-nav-link-border"></span>
                     ...
                     <span class="nav-line-2">account &amp; list
                     <span class="nav-icon nav-arrow" style=" visibility:visible"></span>
                    </span>
                   </nuxt-link>
                   ...
                   <nuxt-link to="/cart" class="nav-a nav-a-2" id="nav-cart">
                    ...
                    <span id="nav-cart-count" class="nav-cart-count nav-cart-0" aria-hidden="true">2</span>
                   </nuxt-link>
                </div>
